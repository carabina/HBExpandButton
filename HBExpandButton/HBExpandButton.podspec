#
#  Be sure to run `pod spec lint HBExpandButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Raizo" => "raizo.cn@gmail.com" }
  # Or just: s.author    = "Raizo"
  # s.authors            = { "Raizo" => "raizo.cn@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Raizo"
  ...
  s.source       = { :git => "https://github.com/Raizo7777/HBExpandButton.git", :tag => "1.0.0" }
